const sentenceService = require("../services/sentenceNew.service");
...
exports.createSentence = async (req, res) => {
  try {
    ...
    const sentence = await sentenceService.createSentence(content, plainText || null);
...
exports.createUserSentence = async (req, res) => {
  try {
    ...
    const result = await sentenceService.createUserSentence(content, userEmail, personId, plainText || null);
  ...
  try {
    ...
    res.json({
      ...
      rejectedSentence: {
        ...
        plainText: sentence.plainText || null,
