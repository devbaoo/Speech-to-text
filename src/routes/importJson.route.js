...
const { importJson, importJsonByUrl, importNewUserText } = require('../controllers/importJson.controller');
...
router.post('/new-user/upload', uploadText.single('file'), importNewUserText);
